...
const SellerLogin = ({ auth, isAuth, authUser, isAuthUser,adminAuth,isAdminAuth }) => {
  ...
  const loginUser = async () => {
    try {
      if (!email.includes("@") || !email.includes(".")) {
        ...
        const response = await fetch(`/api/login-seller`, {
          method: "POST",
          headers: {
        ...
        if (response.status == 400) {
          ...
          // to stay logged in we have to set it to localstorage
          await localStorage.setItem("isAdminAuth", true);

          // State for authentication
          await isAdminAuth(true);

          // This will navigate to events page
          router.push("/seller/dashboard");
          // await isAuthUser(data.email);
        }
      }
    } catch (error) {
      ...
      {!auth ? (
        <div className="overflow-y-hidden">
          <ToastContainer
            ...
            // theme="light"
          />
          <div className="min-w-screen min-h-screen overflow-hidden shadow-lg flex items-center justify-center px-5 py-5">
            <div
            ...
            >
              <div className="md:flex w-full">
                ...
                <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                  ...
                  <div>
                    <div className="flex -mx-3" data-aos="zoom-in">
