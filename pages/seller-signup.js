...
const SellerSignup = () => {
  ...
  const [college, setCollege] = useState("SIGCE");
          ...
          if (fName.length < 3) {
            ...
            if (
              ...
              if (!email.includes("@") || !email.includes(".")) {
                ...
                // posting data to server usin fetch api
                ...
                if (response.status == 409) {
                  ...
                  await toast.success(
                    "Your response is submitted  sucessfully"
                  );
                }
  ...
  return (
    <>
      <ToastContainer
        ...
        // theme="light"
      />{" "}
      <div className="min-w-screen h-auto shadow-lg flex items-center justify-center px-5 py-5">
        <div
          ...
          <div className="md:flex w-full">
            ...
            <div className="w-full md:w-1/2 py-6 px-5 md:px-10">
              <div className="text-center mb-10" data-aos="zoom-out-up">
                ...
                <Link
                  href="/seller-login"
                  className="font-bold text-xl text-yellow-500 cursor-pointer"
                >
                  Login
                </Link>
              ...
              <div>
                <div className="flex -mx-3" data-aos="flip-down">
                  ...
                  <div className="w-1/2 px-3 mb-5" data-aos="flip-down">
                    <label htmlFor="" className="text-xs font-semibold px-1">
                      Last name
                    </label>
                    <div className="flex">
                ...
                <div className="flex flex-col gap-3 items-start my-3 mb-5">
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5" data-aos="flip-down">
                    <label htmlFor="" className="text-xs font-semibold px-1">
                      Enter your email
                    </label>
                    <div className="flex">
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-12" data-aos="flip-down">
                    <label htmlFor="" className="text-xs font-semibold px-1">
                      Create a password
                    </label>
                    <div className="flex">
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5" data-aos="flip-left">
                    <button
